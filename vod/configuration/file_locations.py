...
Constructor which based on a few parameters defines the locations of possible data.
        ...
        self.tracking_label_dir = os.path.join(self.root_dir, 'lidar', 'training', 'label_2_tracking')
        self.detection_label_dir = os.path.join(self.root_dir, 'lidar', 'training', 'label_2')
